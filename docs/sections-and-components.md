...
- Render the hero portrait as a large square illustrated avatar. On hover or keyboard focus, keep the avatar visible and show the original photograph in a rounded preview card.
...
- Hero contact hover cards should use service-specific presentations instead of one shared card style: an airmail envelope for email, a contribution grid for GitHub, a profile summary for social accounts, a notebook preview with a quill icon for personal writing, a metadata preview for personal websites, and an independent academic profile card for Google Scholar. Keep non-contact metadata tooltips top-positioned.
