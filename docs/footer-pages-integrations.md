...
- Line 2: `LLMs.txt` + About this website
- Line 3: copyright
...
- Footer last-updated text, `LLMs.txt`, `About this website`, language control, and theme control should expose concise top-positioned tooltips.
...
- Do not keep separate accessibility or privacy routes; their content is available only through the About This Website page.
