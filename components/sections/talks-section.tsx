	...
	const defaultTalks = [
		{
			...
			type: "Keynote",
			description:
				"Presented recent developments in machine learning applications for academic research, focusing on automated literature review and research trend analysis.",
		...
		},
		{
			...
			type: "Invited Talk",
			description:
				"Discussed the integration of big data analytics in traditional research methodologies and its impact on research outcomes.",
		...
		},
		{
			...
			description:
				"Participated in a panel discussion about the future of academic publishing, focusing on open access and digital transformation.",
