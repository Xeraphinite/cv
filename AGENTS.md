...
This file is now a table of contents for agent instructions. Detailed conventions are split into `docs/*`.
...
5. Finish with documentation hygiene:
   - If a new reusable rule was introduced, update the relevant `docs/*.md`.
   - Keep this TOC and workflow summary current.

## Maintenance Rule
- When a reusable project convention or user preference changes, update the relevant `docs/*.md` file and keep this TOC current.
